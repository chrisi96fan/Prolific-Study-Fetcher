...
chrome_random = (1509, 1012)        # random coordinate in the bottom right corner of the chrome browser
chrome_open_study = (1455, 142)    # opens the study inside of the extension
chrome_automatic = (1629, 543)     # first location for the joining study button in chrome
chrome_not_automatic = (1591, 438)  # second location for the joining study button in chrome
chrome_ai = (1534, 610)            # third location for the joining study button in chrome
